...
SELECT board_NUM, TITLE, CONCAT(BOARD_NUM,'_',TITLE)
FROM board;
...
-- NULL 데이터를 치환하는 함수 IFNULL(컬럼명,NULL값일경우 나오는 데이터)
...
SELECT LENGTH(ENAME), SUM(SAL) FROM emp;
